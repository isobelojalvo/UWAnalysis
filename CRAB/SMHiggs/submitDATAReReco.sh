...
farmoutAnalysisJobs  $1  $header --input-dbs-path=/SingleMuon/Run2016H-PromptReco-v3/MINIAOD ${jobID}_SINGLEMUON2016H $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/SMHiggs/SUB-JSON.py  
