#!/bin/sh
mkdir /nfs_scratch/$USER/ztt_weighted7
cp /nfs_scratch/$USER/ztt_unweighted7/* /nfs_scratch/$USER/ztt_weighted7/.
cd /nfs_scratch/$USER/ztt_weighted7/
...
if [ $weight -eq 1 ]
    ...
    EventWeightsIterative outputFile='WJets.root'   weight=61526.7   histoName='MT/results'
