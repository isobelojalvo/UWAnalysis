...
farmoutAnalysisJobs  $1 --input-files-per-job=1 --vsize-limit=8000 --input-dir=root://cmsxrootd.fnal.gov/ --input-file-list=muQCD.txt --assume-input-files-exist  25ns_muQCD_MVAELE $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/ZTT_25ns/SUB-MC.py  
