...
farmoutAnalysisJobs  $1   --vsize-limit=8000  --input-dir=/store/user/ojalvo/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM/DYJets/   		DYJets    $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/LTau/SUB-MCZ.py
...
farmoutAnalysisJobs  $1   --vsize-limit=8000  --input-dir=/store/user/ojalvo/W1JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V19-v1	 	    		W1Jets_2    $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/LTau/SUB-MCW.py
farmoutAnalysisJobs  $1   --vsize-limit=8000  --input-dir=/store/user/ojalvo/W2JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V19-v1	 	    		W2Jets_2    $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/LTau/SUB-MCW.py
...
farmoutAnalysisJobs  $1   --vsize-limit=8000  --input-dir=/store/user/ojalvo/WZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola		    WZ2L2Q    $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/LTau/SUB-MC.py
...
farmoutAnalysisJobs  $1   --vsize-limit=8000  --input-dir=/store/user/ojalvo/ZZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola		    ZZ2L2Q	  $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/LTau/SUB-MC.py
