...
#include "UWAnalysis/StatTools/interface/DataCardCreatorZTT_Twiki.h"
...
int main (int argc, char* argv[]) 
{
	...
	DataCardCreatorZTT_Twiki creator(parser);
...
//(std::string preselection, std::string categoryselection, std::string prefix)
		creator.makeHiggsShape(parser.stringValue("inclSelection"),parser.stringValue("inclSelection"),"_inclusivemtnotwoprong");
	}
