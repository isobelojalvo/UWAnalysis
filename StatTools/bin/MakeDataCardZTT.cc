...
#include "UWAnalysis/StatTools/interface/DataCardCreatorZTT.h"
...
int main (int argc, char* argv[]) 
{
   ...
   parser.addOption("qcdFile",optutl::CommandLineParser::kString,"File with the QCD","TOP.root");
   ...
   parser.addOption("bSelection",optutl::CommandLineParser::kString,"Anti Btagging requirement for MSSM","(nJetsBTag3Pt20==0&&nJetsPt30<2)");
...
//breaks without this currently
   ...
   parser.addOption("1jet0tag",optutl::CommandLineParser::kString,"Requirement for MSSM Categories 1","J1PtCSVSort>20&&J1EtaCSVSort<2.4&&J1EtaCSVSort>-2.4&&nJetsBTagCSVTPt20==0");
   parser.addOption("1jet1tag",optutl::CommandLineParser::kString,"Requirement for MSSM Categories 2","J1PtCSVSort>20&&J1EtaCSVSort<2.4&&J1EtaCSVSort>-2.4&&nJetsBTagCSVTPt20==1");
   ...
   DataCardCreatorZTT creator(parser);
