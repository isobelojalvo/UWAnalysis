...
float lo =0;
float hi = 300;
TString var ="mJJCSVSort";
TString inputsel = "&&pt2>0&&mJJCSVSort>0&&nJetsBTagCSVMPt20>1";//"&&mJJCSVSort>100&&mJJCSVSort<175&&svMass>120&&svMass<175&&btag>0";//"&&mJJ>50&&mJJ<200";
...
void plotHhh(){
  ...
  TFile *SMHFile = new TFile("/scratch/ojalvo/HhhGenStudies/SMH125.root");
  ...
  TTree* SMHTree = (TTree*)SMHFile->Get("muTauEventTreeFinal/eventTree");
  TH1F* Shape1 = new TH1F("hist2","hist2",bins,lo,hi);
  SMHTree->Draw(+var+">>+hist2","("+selection+")","same");
  ...
  leg->AddEntry(Shape1,"SM Higgs 125","l");
  ...
  */  
  Tcan->SaveAs("~/www/htt/GenStudies/"+var+"2TagReq.png");
}
