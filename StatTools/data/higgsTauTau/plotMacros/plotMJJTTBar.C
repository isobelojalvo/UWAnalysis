...
void plotMJJTTBar(){
  ...
  TFile *HhhFile    = new TFile("/scratch/ojalvo/LTau_12_2/MTEM.root");
  ...
  TLegend *leg = new TLegend(0.55,0.65,0.99,0.99);//  Leg = new TLegend(0.74,0.65,0.99,0.95);
  leg->SetFillColor(0);
  leg->SetFillStyle(0);
  leg->SetBorderSize(0);
  leg->SetHeader("");
  ...
  TTree* HhhTree = (TTree*)HhhFile->Get("muTauEventTree/eventTree");
  ...
  */  
  Tcan->SaveAs("~/www/htt/GenStudies/"+var1+"RegComp2MTEM.png");
}
