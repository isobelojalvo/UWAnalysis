{
   ...
   makeLTauStack("~/www/ztt/muTau_mt","muTauPlots/muTau_mt.root","muTau_inclusive",3,"Total M_{T}","GeV",false,"#tau_{#mu}#tau_{h}","2015",false,false);
   ...
   makeLTauStack("~/www/ztt/muTau_genVisPt1","muTauPlots/muTau_genVisPt1.root","muTau_inclusive",3,"Gen Visible #mu P_{T}","GeV",false,"#tau_{#mu}#tau_{h}","2015",true,false);
   ...
   makeLTauStack("~/www/ztt/muTau_genVisPt2","muTauPlots/muTau_genVisPt2.root","muTau_inclusive",3,"Gen Visible #tau P_{T}","GeV",false,"#tau_{#mu}#tau_{h}","2015",true,false);
   ...
   makeLTauStack("~/www/ztt/muTau_pt","muTauPlots/muTau_pt.root","muTau_inclusive",3,"Higgs Pt","GeV",false,"#tau_{#mu}#tau_{h}","2015",true,false);
   ...
   makeLTauStack("~/www/ztt/muTau_nJetsPt20","muTauPlots/muTau_nJetsPt20.root","muTau_inclusive",3,"Number Jets Pt>20","GeV",false,"#tau_{#mu}#tau_{h}","2015",true,false);
