...
void ssCheckETau(){
  TString selectionNominalOS="pt_1>23&&pt_2>20&&vertices>0&&diLeptons==0&&iso_1<0.1&&tauIso<1.5&&tightElectrons<=1&&charge==0&&mt_1<40";
  TString selectionNominalSS="pt_1>23&&pt_2>20&&vertices>0&&diLeptons==0&&iso_1<0.1&&tauIso<1.5&&tightElectrons<=1&&charge!=0&&mt_1<40";
  TString selectionRelaxedOS = "pt_1>23&&pt_2>20&&vertices>0&&charge==0&&mt_1<40";
  ...
  TString variable = "m_vis"; int bins = 25;float low = 0, high = 300;
  //TString variable = "mt_1"; int bins = 25;float low = 0, high = 200;
  ...
  //TFile *fQCD    = new TFile("/nfs_scratch/laura/emQCD/emQCD50Inf.root");
  ...
  //TTree* treeZ = (TTree*)fZ->Get("eleTauEventTree/eventTree");
