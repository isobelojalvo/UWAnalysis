...
preselection='pt_1>23&&pt_2>20&&vertices>0&&diLeptons==0&&iso_1<0.5&tauIso<5&&tightElectrons<=1&&tightMuons==0&&tauDecayMode!=6&&tauDecayMode!=5&&tauIsoMedium>0.5'
inclselection=preselection
wselection='mt_1>80'
sigSel='mt_1<40'
...
luminosity='166' #pb
direc='/nfs_scratch/laura/ztt_weighted9/'
zttScale='1.'
qcdfactor='0.0'
topSF='1.'
samesign='0'
...
zeroselections='pt_1>23&&pt_2>20&&vertices>0&&diLeptons==0&&tightElectrons<=1&&tightMuons==0&&againstMuonLoose3_2>0&&tauDecayMode!=5&&tauDecayMode!=6'
selections=['tauElectronTightMVA5>0','pt_1>23','tauIso<1.5','iso_1<.1','iso04_1<0.1']
label=['NOtauElectronTight','ALL','NOtauIso','NOiso1','NOiso04']
