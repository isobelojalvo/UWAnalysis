#!/bin/sh
infilename=ztt_unweighted15
filename=ztt_weighted15
mkdir /data/$USER/$filename
#cp /data/$USER/$infilename/* /data/$USER/$filename/.
cd /data/$USER/$filename/

#TTJets.root  WW.root  ZJets.root  diBoson.root  tBar.root
#WJets.root   WZ.root  ZZ.root     t.root
...
if [ $weightH -eq 1 ]
    ...
    echo 'weight higgs'
    EventWeightsIterativeGen outputFile='ggH.root'     weight=1    histoName='TT/results' sumHistoName='sumweights/genWeights'
    ...
    EventWeightsIterativeGen outputFile='vbfH.root'     weight=1    histoName='TT/results' sumHistoName='sumweights/genWeights'
...
if [ $weight -eq 1 ]
    ...
    echo 'Weight WZ 1L1NuQQ'##missing
