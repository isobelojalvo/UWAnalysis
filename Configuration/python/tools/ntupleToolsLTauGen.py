...
def addMuTauEventTreeGen(process,name,src = 'diTausSorted', srcLL = 'diMuonsSorted', srcU='TightMuons', srcE='TightElectrons'):
...
#                               ),
                              ...
                              muTauFirstJetPt1gen = cms.PSet(
                                   pluginType = cms.string("PATMuTauPairFiller"),
                                   src        = cms.InputTag(src),
                                   tag        = cms.string("J1PtBMatched"),
                                   method     = cms.string('J1MatchedB.pt'),
                                   leadingOnly=cms.untracked.bool(True)
                               ),
                                muTauSecondJetPtgen = cms.PSet(
                                    pluginType = cms.string("PATMuTauPairFiller"),
                                    src        = cms.InputTag(src),
                                    tag        = cms.string("J2PtBMatched"),
                                    method     = cms.string('J2MatchedB.pt'),
                                    leadingOnly=cms.untracked.bool(True)
                                ),
                                muTauFirstJetEtaGen = cms.PSet(
                                    pluginType = cms.string("PATMuTauPairFiller"),
                                    src        = cms.InputTag(src),
                                    tag        = cms.string("J1EtaBMatched"),
                                    method     = cms.string('J1MatchedB.eta'),
                                    leadingOnly=cms.untracked.bool(True)
                                ),
                                muTauSecondJetEtaGen = cms.PSet(
                                    pluginType = cms.string("PATMuTauPairFiller"),
                                    src        = cms.InputTag(src),
                                    tag        = cms.string("J2EtaBMatched"),
                                    method     = cms.string('J2MatchedB.eta'),
                                    leadingOnly=cms.untracked.bool(True)
                                ),
                                muTauFirstJetPhiGen = cms.PSet(
                                    pluginType = cms.string("PATMuTauPairFiller"),
                                    src        = cms.InputTag(src),
                                    tag        = cms.string("J1PhiBMatched"),
                                    method     = cms.string('J1MatchedB.phi'),
                                    leadingOnly=cms.untracked.bool(True)
                                ),
                                muTauSecondJetPhiGen = cms.PSet(
                                    pluginType = cms.string("PATMuTauPairFiller"),
                                    src        = cms.InputTag(src),
                                    tag        = cms.string("J2PhiBMatched"),
                                    method     = cms.string('J2MatchedB.phi'),
                                    leadingOnly=cms.untracked.bool(True)
                                ),
                                muTauFirstJetFlavorGen = cms.PSet(
                                    pluginType = cms.string("PATMuTauPairFiller"),
                                    src        = cms.InputTag(src),
                                    tag        = cms.string("J1FlavorBMatched"),
                                    method     = cms.string('J1MatchedB.partonFlavour'),
                                    leadingOnly=cms.untracked.bool(True)
                                ),
                                muTauSecondJetFlavorGen = cms.PSet(
                                    pluginType = cms.string("PATMuTauPairFiller"),
                                    src        = cms.InputTag(src),
                                    tag        = cms.string("J2FlavorBMatched"),
                                    method     = cms.string('J2MatchedB.partonFlavour'),
                                    leadingOnly=cms.untracked.bool(True)
                                ),
                               muTauFirstJetCSVbtagGen = cms.PSet(
                                   pluginType = cms.string("PATMuTauPairFiller"),
                                   src        = cms.InputTag(src),
                                   tag        = cms.string("J1CSVbtagBMatched"),
                                   method     = cms.string('J1MatchedB.bDiscriminator("combinedSecondaryVertexBJetTags")'),
                                   leadingOnly=cms.untracked.bool(True)
                               ),
                               muTauSecondJetCSVbtagGen = cms.PSet(
                                   pluginType = cms.string("PATMuTauPairFiller"),
                                   src        = cms.InputTag(src),
                                   tag        = cms.string("J2CSVbtagBMatched"),
                                   method     = cms.string('J2MatchedB.bDiscriminator("combinedSecondaryVertexBJetTags")'),
                                   leadingOnly=cms.untracked.bool(True)
                               ),
