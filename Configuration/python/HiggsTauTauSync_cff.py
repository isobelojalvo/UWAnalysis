...
ETanalysisConfigurator.addDiCandidateModule('eleTaus','PATEleTauPairProducer','smearedElectronsET','smearedTausET','slimmedMETs','smearedTausET','smearedJetsET',1,9999,text = 'AtLeastOneEleTau',leadingObjectsOnly = False,dR = 0.5,recoMode = "",genParticles='genDaughters')
...
i#ETanalysisConfigurator.addSelector('eleTausEleIsolationLoose','PATEleTauPairSelector','leg1.userFloat("dBRelIso")<0.5','electronIsolationLoose',1)
...
MTanalysisConfigurator.addSelector('diTausMuonID','PATMuTauPairSelector','abs(leg1.userFloat("dz"))<0.2&&abs(leg1.userFloat("ipDXY"))<0.045','MuonID',1)#FIXME
