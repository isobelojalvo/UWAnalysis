...
#abs(leg1.userFloat("ipDXY"))<0.045&&abs(leg2.userFloat("ipDXY"))<0.045
...
#MTanalysisConfigurator.addSelector('diTausMuonMediumID','PATMuTauPairSelector','leg1.muonID("POG_ID_Medium")>0','MuonMediumID',1)
