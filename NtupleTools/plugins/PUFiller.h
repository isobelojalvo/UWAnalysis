...
class PUFiller : public NtupleFillerBase {
 public:
      ...
      tag_(iConfig.getParameter<std::string>("tag"))
	{
	  ...
	  std::string fPUDATAloc = "/src/UWAnalysis/Configuration/data/Jun17_2016BPileupHistogram.root";
	  //std::string fPUDATAloc = "/src/UWAnalysis/Configuration/data/Data_Pileup_2015D_Feb02.root";
