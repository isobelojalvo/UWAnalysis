...
void createVertexDistribution(){
  ...
  TFile *f    = new TFile("/nfs_scratch/laura/ztt_unweighted14_Golden/muDATA.root");
  ...
  TFile *f1    = new TFile("/nfs_scratch/laura/ztt_weighted13/ZJets.root");
  ...
  TFile f2("/nfs_scratch/laura/ztt_weighted13/vertices.root","RECREATE");
